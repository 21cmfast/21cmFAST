...
class TestWriteTemplate:
    ...
    # Roundtrip the existing templates without changing their model settings.
    # Qin20 triggers the USE_MINI_HALOS/V_CB_MODEL mismatch; const-zeta,
    # Munoz21, and EOS21 trigger the EPS conditional-mass-function advisory.
    # Scoped per-alias below rather than applied to all 25 template aliases,
    # since only these 4 actually fire.
