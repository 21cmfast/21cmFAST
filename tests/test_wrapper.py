...
def test_coeval_vs_low_level(ic):
    ...
    np.testing.assert_allclose(coeval.Tk_box, st.Tk_box, rtol=1.3e-4)
    np.testing.assert_allclose(coeval.Ts_box, st.Ts_box, rtol=1.3e-4)
    np.testing.assert_allclose(coeval.x_e_box, st.x_e_box, rtol=1.3e-4)
