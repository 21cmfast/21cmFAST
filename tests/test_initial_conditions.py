...
def test_box_shape(basic_init_box):
    ...
    shape = (35, 35, 35)
    hires_shape = tuple(3 * s for s in shape)
    ...
    assert basic_init_box.lowres_vcb.shape == shape
    assert basic_init_box.hires_density.shape == hires_shape
    assert basic_init_box.hires_vx.shape == hires_shape
    assert basic_init_box.hires_vy.shape == hires_shape
    assert basic_init_box.hires_vz.shape == hires_shape
    assert basic_init_box.hires_vx_2LPT.shape == hires_shape
    assert basic_init_box.hires_vy_2LPT.shape == hires_shape
    assert basic_init_box.hires_vz_2LPT.shape == hires_shape
    assert basic_init_box.hires_vcb.shape == hires_shape
