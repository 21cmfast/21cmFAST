...
#define MAX_DELTAC_FRAC \
  (float)0.99         // max delta/deltac for the mass function integrals
...
double conditional_mf(double growthf, double lnM, double delta_cond,
                      double sigma_cond, int HMF);
