/* Function prototypes for the xray/lya tables as a function of energy and
 * ionisation fraction*/
#ifndef _ELEC_INT_H
#define _ELEC_INT_H
...
// Primary functions to compute heating fractions and number of Lya photons or
// ionization produced, Note that En is the energy of the *primary* photon, so
// the energy in the initial ionization is included in all these. All energies
// are in eV. xHII_call is the desired ionized fraction.
...
// heating_helper_progs.c functions
