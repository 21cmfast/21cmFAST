...
NB_MODULE(c_21cmfast, m) {
  ...
  nb::class_<UserParams>(m, "UserParams")
      ...
      .def_rw("USE_RELATIVE_VELOCITIES",
      ...
      .def_rw("USE_INTERPOLATION_TABLES",
                     &UserParams::USE_INTERPOLATION_TABLES)
      .def_rw("INTEGRATION_METHOD_ATOMIC",
                     &UserParams::INTEGRATION_METHOD_ATOMIC)
      .def_rw("INTEGRATION_METHOD_MINI",
  ...
  nb::class_<AstroParams>(m, "AstroParams")
      ...
      .def_rw("UPPER_STELLAR_TURNOVER_MASS",
                     &AstroParams::UPPER_STELLAR_TURNOVER_MASS)
      .def_rw("UPPER_STELLAR_TURNOVER_INDEX",
  ...
  nb::class_<FlagOptions>(m, "FlagOptions")
      ...
      .def_rw("USE_MASS_DEPENDENT_ZETA",
      ...
      .def_rw("HALO_SCALING_RELATIONS_MEDIAN",
  ...
  nb::class_<GlobalParams>(m, "GlobalParams")
      ...
      .def_rw("SMOOTH_EVOLVED_DENSITY_FIELD",
      ...
      .def_rw("CRIT_DENS_TRANSITION",
                     &GlobalParams::CRIT_DENS_TRANSITION)
      .def_rw("MIN_DENSITY_LOW_LIMIT",
      ...
      .def_rw("NUM_FILTER_STEPS_FOR_Ts",
  ...
  nb::class_<IonizedBox>(m, "IonizedBox")
      ...
      .def_rw("log10_Mturnover_MINI_ave",
