...
typedef struct InitialConditions {
  ...
  float *hires_density, *hires_vx, *hires_vy, *hires_vz, *hires_vx_2LPT,
      *hires_vy_2LPT, *hires_vz_2LPT;  // cw addition
  float *lowres_vcb;
} InitialConditions;
...
typedef struct HaloBox {
  ...
  // Average volume-weighted log10 Turnover masses are kept in order to compare
  // with the expected MF integrals
