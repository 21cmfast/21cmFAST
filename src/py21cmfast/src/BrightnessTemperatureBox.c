...
#pragma omp parallel shared(delta_T_RSD_LOS, box, ionized_box, v, x_val1, x_val2, x_pos, x_pos_offset, subcell_width) private(i, j, k, ii, d1_low, d2_low, d1_high, d2_high, subcell_displacement, RSD_pos_new,                      \
