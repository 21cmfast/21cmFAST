...
void inspectInitialConditions(InitialConditions *x, int print_pid, int print_corners, int print_first,
...
void inspectPerturbedField(PerturbedField *x, int print_pid, int print_corners, int print_first,
                           int HII_DIM, float NCF){
    int i;
...
void inspectTsBox(TsBox *x, int print_pid, int print_corners, int print_first, int HII_DIM, float NCF){
    int i;
...
void inspectIonizedBox(IonizedBox *x, int print_pid, int print_corners, int print_first, int HII_DIM, float NCF){
    int i;
...
void inspectBrightnessTemp(BrightnessTemp *x, int print_pid, int print_corners, int print_first, int HII_DIM, float NCF){
    int i;
