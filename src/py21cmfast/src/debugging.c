...
void writeUserParams(UserParams *p){
    LOG_INFO("\n        UserParams:\n"
                ...
                "       INTEGRATION_METHOD_ATOMIC=%2d, INTEGRATION_METHOD_MINI=%2d, PERTURB_ALGORITHM=%1d, MINIMIZE_MEMORY=%1d,\n"
             ...
             p->INTEGRATION_METHOD_ATOMIC,p->INTEGRATION_METHOD_MINI,p->PERTURB_ALGORITHM,p->MINIMIZE_MEMORY,p->KEEP_3D_VELOCITIES,
             p->SAMPLER_MIN_MASS,p->SAMPLER_BUFFER_FACTOR,p->N_COND_INTERP,p->N_PROB_INTERP,p->MIN_LOGPROB,
