...
int ComputeHaloField(float redshift_desc, float redshift, MatterParams *matter_params,
                     MatterFlags *matter_flags, CosmoParams *cosmo_params,
                     AstroParams *astro_params, AstroFlags *astro_flags, InitialConditions *boxes,
...
int ComputePerturbHaloField(float redshift, MatterParams *matter_params, MatterFlags *matter_flags,
                            ...
                            AstroFlags *astro_flags, InitialConditions *boxes, HaloField *halos,
...
int single_test_sample(MatterParams *matter_params, MatterFlags *matter_flags,
                       CosmoParams *cosmo_params, AstroParams *astro_params,
                       AstroFlags *astro_flags, int seed, int n_condition, float *conditions,
...
int test_halo_props(double redshift, MatterParams *matter_params, MatterFlags *matter_flags,
                    ...
                    float *sfr_rnd, float *xray_rng, float *halo_props_out);
